...
import { prizeRef, kuponRef, winnerRef } from '../firebase';
            ...
            <div class="px-4 py-5 flex-auto">
                <div class="tab-content tab-space">
                                    ...
                                    <table class="min-w-full">
                                        ...
                                        <tbody class="bg-white">
                                            <tr v-for="prize in prizeList.sort((a, b) => a.id - b.id)" :key="prize.id">
                                                ...
                                                <td
                                                    class="py-4 whitespace-no-wrap border-b border-gray-200 text-gray-900">
                    ...
                    <div :class="{ 'hidden': openTab !== 2, 'block': openTab === 2 }">
                        <ul>
                            <li v-for="kupon in kuponList" :key="kupon.id">
                                <span>{{ kupon.kode }}</span>
                            </li>
                        </ul>
                    </div>
                    <div :class="{ 'hidden': openTab !== 3, 'block': openTab === 3 }">
                        <ul>
                            <li v-for="winner in winnerList" :key="winner.id">
