...
import { db, prizeScratchRef, kuponScratchRef, winnerScratchRef } from '../firebase';
import PrizeList from './Scratch/PrizeList.vue';
import VoucherKode from './Scratch/VoucherKode.vue';
import Winner from './Scratch/Winner.vue';
